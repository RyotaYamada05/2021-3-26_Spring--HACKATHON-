...
HRESULT CArea4::Init(CMap::MAP_AREA m_Area_Type)
{
	...
	//アイテムの生成
	CItem::Create(D3DXVECTOR3(600.0f, 700.0f, 0.0f), ITEM_SIZE, CItem::ITEM_DIAMOND);

	////アイテムの生成
	//CItem::Create(D3DXVECTOR3(150.0f, 600.0f, 0.0f), ITEM_SIZE, CItem::ITEM_TREASURE);

	////アイテムの生成
	//CItem::Create(D3DXVECTOR3(900.0f, 300.0f, 0.0f), ITEM_SIZE, CItem::ITEM_TRAP);
	return S_OK;
}
